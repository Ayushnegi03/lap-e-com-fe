...
const UserDashboard = () => {
  ...
  // Dummy stats for user
  const stats = [
    { label: "My Orders", value: 12, bgColor: "#4caf50" },
    { label: "Wishlist", value: 5, bgColor: "#2196f3" },
    { label: "Cart Items", value: 3, bgColor: "#ff9800" },
    { label: "Saved for Later", value: 2, bgColor: "#9c27b0" },
  ];

  // Dummy recent orders
  const recentOrders = [
    { id: 1, product: "Dell Inspiron", amount: "₹65,000", status: "Delivered" },
    { id: 2, product: "HP Pavilion", amount: "₹72,000", status: "Pending" },
    { id: 3, product: "MacBook Air", amount: "₹95,000", status: "Cancelled" },
  ];
  ...
  return (
    <div style={{ padding: 24, fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      ...
      <header style={{ marginBottom: 30 }}>
        <h1 style={{ fontSize: 32, color: "#222", marginBottom: 8 }}>
          Welcome, {user?.username}!
        </h1>
        <p style={{ color: "#555", fontSize: 16 }}>
          Here's an overview of your account and orders.
        </p>
      </header>
